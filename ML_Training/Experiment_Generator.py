...
def generate_exp_MobileNetV2(model_name):
...
exp_MobileNETV2 = generate_exp_MobileNetV2("MobileNETV2")
...
save_settings(exp_MobileNETV2,config['settings']+"/experiments_MobileNETV2.json")
